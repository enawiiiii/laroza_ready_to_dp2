...
import {
  ...
  Chip, CircularProgress, Alert, Button, TextField, InputAdornment,
} from "@mui/material";
...
export default function Sales() {
  ...
  const filtered = sales.filter((s) => {
    ...
    return s._id?.toLowerCase().includes(term);
  });

  return (
    <Box>
      <Box sx={{ mb: 4 }}>
        <Typography variant="h4" fontWeight={700}>مبيعاتي</Typography>
      ...
      {loading ? (
        ...
        <Card>
          <CardContent sx={{ textAlign: "center", py: 6 }}>
            ...
            <Typography color="text.secondary" variant="h6">لا توجد مبيعات</Typography>
          </CardContent>
        </Card>
      ) : (
        <Card>
